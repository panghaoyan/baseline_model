...
LabelWeightDict = {"Crack breaks and collapes":1.00,"Surface damage":0.5518,"Production error":0.2896,"Deformation":0.1622,
                   "Displaced joint":0.6419,"Intruding sealing material":0.1847,"Roots":0.3559,"Infiltration":0.3131,
                   "Settled deposits":0.0811,"Attached deposits":0.2275,"Obstacle":0.2477,"Branch pipe":0.0901,
                   "Chiseled Connection":0.4167,"Drilled Connection":0.4167,"Lateral reinstatement":0.9009,
                   "Connection with transition profile":0.3829,"Connection with construction changes":0.4396}
...
def Sewer_evaluation(scores, targets, weights, threshold=0.5):
